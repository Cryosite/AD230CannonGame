...
public class CannonView extends SurfaceView 
   ...
   private void updatePositions(double elapsedTimeMS) {
      ...
      //if there is currently a shot fired
      if (cannonballOnScreen) {
         ...
         //check for cannonball collision with target
            ...
            if ((section >= 0 && section < TARGET_PIECES) && 
               ...
               }//endif - (++targetPiecesHit == TARGET_PIECES)
            }//endif - Piece has not been hit
         }//endelseif - collision with target
      }//endif - (cannonballOnScreen)
   ...
   }//updatePositions(double elapsedTimeMS)
   ...
   }//fireCannonball(MotionEvent event)
   ...
   public void drawGameElements(Canvas canvas) {
      ...
      }//endfor - (int i = 1; i <= TARGET_PIECES; ++i)
   }//drawGameElements(Canvas canvas)
   ...
   }//showGameOverDialog(int messageId)
   ...
   public void surfaceDestroyed(SurfaceHolder holder) {
      ...
      while (retry) {
         ...
         }//endcatch - (InterruptedException e)
      }//endwhile - (retry)
